class Solution:
    def merge(self, nums1: List[int], m: int, nums2: List[int], n: int) -> None:
        ...
        # THIS IS A REALLU IMPORTANT BASE CASE TO UNDERSTAND AS IT IS BASICALLY SAYING THAT IF WE OINLy SHIFTED ON nums1
        # that means nothing from nums2 copied over thus we must do copy over whats remaining.
